                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                ...
                                <?php
                                    // Prefer explicit rating field, fallback to avg_rating if available
                                    $rating = isset($campground['rating']) ? (float)$campground['rating'] : (isset($campground['avg_rating']) ? (float)$campground['avg_rating'] : null);
                                    $displayRating = $rating !== null ? number_format($rating, 1) : '-';
                                ?>
                                <div class="text-warning">
                                    ...
                                    ?>
                                    <span class="ms-1"><?= $displayRating ?></span>
                                </div>
                            </div>
                            <h5 class="card-title">
                                ...
                                <div class="row text-center">
                                    <div class="col-4">
                                        <div class="border-end">
                                            <h6 class="text-success"><?= $rating !== null ? number_format($rating, 1) : '-' ?></h6>
