    ...
    <form method="post" action="<?= base_url('admin/merchandise') ?>" enctype="multipart/form-data">
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="file-upload-area" onclick="document.getElementById('merch-image-file-input').click()">
                ...
                <div id="merch-image-preview" style="display:none; margin-top:1rem;">
                    <img id="merch-preview-img" src="" alt="Preview" style="max-width:300px;border-radius:8px;"/>
                </div>
