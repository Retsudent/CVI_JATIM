...
<div class="admin-form-container">
    <div class="admin-form-header">
        ...
        <p class="subtitle">Buat event menarik untuk menarik lebih banyak peserta</p>
    </div>
    ...
    <form method="post" action="<?= base_url('admin/events') ?>" enctype="multipart/form-data">
        ...
        <div class="form-grid">
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" required placeholder="Contoh: Camping Adventure di Wirotaman" value="<?= esc(old('title')) ?>" />
                    <div class="form-help">Buat judul yang menarik dan mudah diingat</div>
                </div>
                
                <div class="form-group">
                    <label>Deskripsi <span class="required">*</span></label>
                    <textarea name="description" required placeholder="Jelaskan detail event, kegiatan yang akan dilakukan, dan manfaat yang akan didapat peserta..."><?= esc(old('description')) ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="location" required placeholder="Contoh: Wirotaman Campground, Malang" value="<?= esc(old('location')) ?>" />
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="start_date" required value="<?= esc(old('start_date')) ?>" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="capacity" min="1" placeholder="50" value="<?= esc(old('capacity')) ?>" />
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="price" placeholder="150000" value="<?= esc(old('price')) ?>" />
            ...
            <div class="form-group">
                ...
                <select name="status">
                    <option value="upcoming" <?= old('status') === 'upcoming' ? 'selected' : '' ?>>⏳ Upcoming - Event akan datang</option>
                    <option value="ongoing" <?= old('status') === 'ongoing' ? 'selected' : '' ?>>🟢 Ongoing - Event sedang berlangsung</option>
                    <option value="completed" <?= old('status') === 'completed' ? 'selected' : '' ?>>✅ Completed - Event selesai</option>
                    <option value="cancelled" <?= old('status') === 'cancelled' ? 'selected' : '' ?>>❌ Cancelled - Event dibatalkan</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <div class="file-upload-area" id="event-upload-area" onclick="document.getElementById('image-file-input').click()">
