...
class CampgroundModel extends Model
{
    ...
    protected $validationRules = [
        ...
        'capacity_tent' => 'permit_empty|integer',
        'capacity_people' => 'permit_empty|integer',
        'capacity_parking' => 'permit_empty|integer',
        'address' => 'permit_empty|max_length[1000]',
        'coordinates_lat' => 'permit_empty|max_length[64]',
        'coordinates_lng' => 'permit_empty|max_length[64]',
